...
<head>
    ...
    <title>Xác Minh Đăng Ký - NHTravel</title>
</head>
                    ...
                    <tr>
                        <td
                            ...
                            <h2 style="margin: 0; color: #ffffff; font-size: 24px; font-weight: 300;">
                                Chào mừng bạn đến với NHTravel!
                            </h2>
                        </td>
                    </tr>
                        ...
                        <td style="padding: 40px 30px;">
                            <div style="text-align: center; margin-bottom: 30px;">
                                <h3 style="color: #333333; font-size: 22px; margin-bottom: 20px; font-weight: 600;">
                                    Xác Minh Tài Khoản Du Lịch Của Bạn
                                </h3>
                                <p style="color: #666666; font-size: 16px; margin-bottom: 25px; line-height: 1.8;">
                                    Cảm ơn <strong>{{ $data['ho_ten'] }}</strong> đã đăng ký tài khoản tại
                                    <strong>NHTravel</strong>!
                                    Để bắt đầu hành trình khám phá những tour du lịch trong nước & quốc tế,
                        ...
                        <td style="padding: 0 30px 40px 30px;">
                            <div
                                ...
                                <h4 style="color: #ffffff; font-size: 18px; margin-bottom: 15px; font-weight: 600;">
                                    ✈️ Điều tuyệt vời đang chờ bạn tại HiTravel:
                                </h4>
