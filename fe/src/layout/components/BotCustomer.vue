<template>
    <footer class="text-white text-center" style="background-color: #3399FF;">
                ...
                <div class="row text-start">
                    ...
                    <div class="col-lg-2 col-md-6 mb-4 mb-md-0">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li class="mb-2">
                                <a href="/" class="text-white text-decoration-none">Tour nổi bật</a>
                            </li>
                            <li class="mb-2">
                                <a href="/" class="text-white text-decoration-none">Tin tức</a>
                            </li>
                            <li>
                                <a href="/" class="text-white text-decoration-none">Khuyến mãi</a>
                            </li>
                        </ul>
                    </div>
